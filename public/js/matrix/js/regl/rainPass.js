...
export default ({ regl, config, lkg }) => {
	...
	const rainPassIntro = loadText("/js/matrix/shaders/glsl/rainPass.intro.frag.glsl");
	const introUniforms = {
		...commonUniforms,
	...
	const rainPassRaindrop = loadText("/js/matrix/shaders/glsl/rainPass.raindrop.frag.glsl");
	...
	const rainPassSymbol = loadText("/js/matrix/shaders/glsl/rainPass.symbol.frag.glsl");
	...
	const rainPassEffect = loadText("/js/matrix/shaders/glsl/rainPass.effect.frag.glsl");
	...
	const rainPassVert = loadText("/js/matrix/shaders/glsl/rainPass.vert.glsl");
	const rainPassFrag = loadText("/js/matrix/shaders/glsl/rainPass.frag.glsl");
