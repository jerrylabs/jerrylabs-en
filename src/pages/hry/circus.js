    ...
    <Layout className="game">
      ...
      <div className="container game__panel">
        <div className="game__download">
          <p className="big">
            Zábavná karetní hra volně šiřitelná na základě <Link to="/licence/">licence Creative Commons</Link>.
            ZIP archiv (42 MB) obsahuje dvě PDF s kartami, návod k vytištění a pravidla hry. Hru si zde můžete stáhnout a vytisknout nebo nechat u nás vyrobit.
