...
export default () => {
  ...
  return (
    <Layout>
      <Jumbotron title="Webs from JerryLabs" className="jumbotron__matrix" image="matrix" />
      <section>
      ...
      <section>
        <p className="center">
          Do you need to build or launch a website? Do not hesitate to <Link to="/contact">contact us</Link>!
        </p>
      </section>
      <FsLightbox
